...
--	type STD_LOGIC_2D is array (NATURAL RANGE <>, NATURAL RANGE <>) of STD_LOGIC;
	...
	SIGNAL sub_wire2	: STD_LOGIC_2D (7 DOWNTO 0, 12 DOWNTO 0);
...
BEGIN
	sub_wire9    <= data0x(12 DOWNTO 0);
	sub_wire8    <= data1x(12 DOWNTO 0);
	sub_wire7    <= data2x(12 DOWNTO 0);
	sub_wire6    <= data3x(12 DOWNTO 0);
	sub_wire5    <= data4x(12 DOWNTO 0);
	sub_wire4    <= data5x(12 DOWNTO 0);
	sub_wire3    <= data6x(12 DOWNTO 0);
	result    <= sub_wire0(12 DOWNTO 0);
	sub_wire1    <= data7x(12 DOWNTO 0);
