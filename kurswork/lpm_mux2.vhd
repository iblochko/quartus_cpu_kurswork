...
ENTITY lpm_mux2 IS
	...
	(
		...
		data10x		: IN STD_LOGIC_VECTOR (12 DOWNTO 0);
		data11x		: IN STD_LOGIC_VECTOR (12 DOWNTO 0);
		data12x		: IN STD_LOGIC_VECTOR (12 DOWNTO 0);
		...
		data8x		: IN STD_LOGIC_VECTOR (12 DOWNTO 0);
		data9x		: IN STD_LOGIC_VECTOR (12 DOWNTO 0);
...
--	type STD_LOGIC_2D is array (NATURAL RANGE <>, NATURAL RANGE <>) of STD_LOGIC;
	...
	SIGNAL sub_wire2	: STD_LOGIC_2D (12 DOWNTO 0, 12 DOWNTO 0);
	...
	SIGNAL sub_wire9	: STD_LOGIC_VECTOR (12 DOWNTO 0);
	SIGNAL sub_wire10	: STD_LOGIC_VECTOR (12 DOWNTO 0);
	SIGNAL sub_wire11	: STD_LOGIC_VECTOR (12 DOWNTO 0);
	SIGNAL sub_wire12	: STD_LOGIC_VECTOR (12 DOWNTO 0);
	SIGNAL sub_wire13	: STD_LOGIC_VECTOR (12 DOWNTO 0);
	SIGNAL sub_wire14	: STD_LOGIC_VECTOR (12 DOWNTO 0);

BEGIN
	sub_wire14    <= data0x(12 DOWNTO 0);
	sub_wire13    <= data1x(12 DOWNTO 0);
	sub_wire12    <= data2x(12 DOWNTO 0);
	sub_wire11    <= data3x(12 DOWNTO 0);
	sub_wire10    <= data4x(12 DOWNTO 0);
	sub_wire9    <= data5x(12 DOWNTO 0);
	sub_wire8    <= data6x(12 DOWNTO 0);
	sub_wire7    <= data7x(12 DOWNTO 0);
	sub_wire6    <= data8x(12 DOWNTO 0);
	sub_wire5    <= data9x(12 DOWNTO 0);
	sub_wire4    <= data10x(12 DOWNTO 0);
	sub_wire3    <= data11x(12 DOWNTO 0);
	result    <= sub_wire0(12 DOWNTO 0);
	sub_wire1    <= data12x(12 DOWNTO 0);
	...
	sub_wire2(12, 11)    <= sub_wire1(11);
	sub_wire2(12, 12)    <= sub_wire1(12);
	...
	sub_wire2(11, 11)    <= sub_wire3(11);
	sub_wire2(11, 12)    <= sub_wire3(12);
	...
	sub_wire2(10, 11)    <= sub_wire4(11);
	sub_wire2(10, 12)    <= sub_wire4(12);
	...
	sub_wire2(9, 11)    <= sub_wire5(11);
	sub_wire2(9, 12)    <= sub_wire5(12);
	...
	sub_wire2(8, 11)    <= sub_wire6(11);
	sub_wire2(8, 12)    <= sub_wire6(12);
	...
	sub_wire2(7, 11)    <= sub_wire7(11);
	sub_wire2(7, 12)    <= sub_wire7(12);
	...
	sub_wire2(6, 11)    <= sub_wire8(11);
	sub_wire2(6, 12)    <= sub_wire8(12);
	...
	sub_wire2(5, 11)    <= sub_wire9(11);
	sub_wire2(5, 12)    <= sub_wire9(12);
	...
	sub_wire2(4, 11)    <= sub_wire10(11);
	sub_wire2(4, 12)    <= sub_wire10(12);
	...
	sub_wire2(3, 11)    <= sub_wire11(11);
	sub_wire2(3, 12)    <= sub_wire11(12);
	...
	sub_wire2(2, 11)    <= sub_wire12(11);
	sub_wire2(2, 12)    <= sub_wire12(12);
	...
	sub_wire2(1, 11)    <= sub_wire13(11);
	sub_wire2(1, 12)    <= sub_wire13(12);
	...
	sub_wire2(0, 11)    <= sub_wire14(11);
	sub_wire2(0, 12)    <= sub_wire14(12);
...
-- Retrieval info: USED_PORT: data10x 0 0 13 0 INPUT NODEFVAL data10x[12..0]
-- Retrieval info: USED_PORT: data11x 0 0 13 0 INPUT NODEFVAL data11x[12..0]
-- Retrieval info: USED_PORT: data12x 0 0 13 0 INPUT NODEFVAL data12x[12..0]
...
-- Retrieval info: USED_PORT: data8x 0 0 13 0 INPUT NODEFVAL data8x[12..0]
-- Retrieval info: USED_PORT: data9x 0 0 13 0 INPUT NODEFVAL data9x[12..0]
...
-- Retrieval info: CONNECT: @data 1 12 13 0 data12x 0 0 13 0
-- Retrieval info: CONNECT: @data 1 11 13 0 data11x 0 0 13 0
-- Retrieval info: CONNECT: @data 1 10 13 0 data10x 0 0 13 0
-- Retrieval info: CONNECT: @data 1 9 13 0 data9x 0 0 13 0
-- Retrieval info: CONNECT: @data 1 8 13 0 data8x 0 0 13 0
